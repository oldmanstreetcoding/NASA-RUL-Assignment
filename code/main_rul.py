...
def display_menu():
    ...
    print("1. FD001") # Option 1: FD001 dataset only
    print("2. FD001 + Tuning") # Option 2: FD001 with hyperparameter tuning
    print("3. FD002") # Option 3: FD002 dataset only
    print("4. FD002 + Tuning") # Option 4: FD002 with hyperparameter tuning
    print("5. FD001 & FD002") # Option 5: Both datasets without tuning
...
def main():
    ...
    if option in ['1', '2', '3', '4', '5', '6']:
        ...
        for fd in fd_name:
            ...
            # Implements key feature engineering techniques and handles missing data
            ...
            # Store test data and model paths for evaluation after training
            evaluation_data[fd] = {
                'test_df': test_df,
    ...
    # Evaluate the performance of LSTM and GRU models after training
